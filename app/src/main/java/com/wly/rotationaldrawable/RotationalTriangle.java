 ...
 */
public class RotationalTriangle extends ImageView {

    private float parameter;
    private RotationalTriangleDrawable drawable;

    public RotationalTriangle(Context context) {
        super(context);
        init();
    }

    public RotationalTriangle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RotationalTriangle(Context context, AttributeSet attrs, int defStyle) {
